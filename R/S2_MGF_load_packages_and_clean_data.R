...
#Main script to load packages, make phyloseq objects, and subset objects by site and time point

#by Steve Formel
#Last updated October 15, 2021

#This is analysis for the S2_MGF project mainly done in the package "phyloseq" with the help of many other packages.
#Biom tables were created in QIIME (1.9.1), work is described in "S2_project_notes.md"
...
#Note that were was also bacterial DNA sequenced and used in other papers, but not in this one.  All lines refering to bacteria are kept in for reference but aren't relevant to the S2_MGF manuscript.

bac.biom <- import_biom("../data/QIIME_output/Soil2/biom_tables/Soil2_16S_100.biom", 
                        parseFunction=parse_taxonomy_greengenes)
fung.biom <- import_biom("../data/QIIME_output/Soil2/biom_tables/Soil2_ITS_100.biom", 
                         parseFunction=parse_taxonomy_greengenes)
...
#Bacteria were not analyzed in the publication, but were left in this script as it was used in other exploratory analyses.
