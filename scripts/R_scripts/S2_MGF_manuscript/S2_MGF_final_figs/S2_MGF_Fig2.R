...
voi.hill.table$estimate_type <- "Observed"
voi.hill.table$filtered <- "yes"

voi.hill.table.observed.F <- voi.hill.table
...
voi.hill.table.extrapolated.F <- voi.hill.table

voi.hill.table <- rbind(voi.hill.table.observed.NF, voi.hill.table.observed.F, voi.hill.table.extrapolated.NF, voi.hill.table.extrapolated.F )
