...
Run PERMANOVA on Bray-Curtis dissimilarity, Jaccard index, and Aitchison distance.  Both filtered and unfiltered versions were run depending on which line was uncommented below.  Ran PERMANOVAs with and without oil to corroborte the dbRDA run afterward.
