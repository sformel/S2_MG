...
Putting all the above plots together and saving as a file.
...
Run the same as above, but with rare species filtered out to see if it makes a difference in the number of samples needed.
