...
#Last updated 12 Nov 2020 by Steve Formel
...
write.csv(x = C,file = "images/manuscript/S2_MGF_final/S2_MGF_mantel_comm_comp.csv", row.names = FALSE)
...
write.csv(x = C,file = "images/manuscript/S2_MGF_final/S2_MGF_mantel_oil.csv", row.names = FALSE)
